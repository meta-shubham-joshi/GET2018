...
import com.metacube.training.EmployeesPortal.mappers.JobDetailsMapper;
...
private JdbcTemplate jdbcTemplate;
	...
	public JobDetails getJobDetailsByEmployeeCode(String empCode) {
		...
		try {
		jobDetails = jdbcTemplate.queryForObject(SQL_FIND_JOBDETAILS, new Object[] {empCode}, new JobDetailsMapper());
	...
	public boolean updateJobDetailsByEmployeeCode(JobDetails jobDetails) {
		return jdbcTemplate.update(SQL_UPDATE_JOB_DETAILS, jobDetails.getDate_of_joining(), jobDetails.getTotal_exp(), jobDetails.getJob_code(), jobDetails.getReporting_mgr(), jobDetails.getTeam_lead(),jobDetails.getCurr_proj_id(), jobDetails.getEmp_code()
				) > 0;
	}
