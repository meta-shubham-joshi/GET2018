...
public class AreaProxy implements com.metacube.Area {
  private String _endpoint = null;
  private com.metacube.Area area = null;
  ...
  private void _initAreaProxy() {
    try {
      area = (new com.metacube.AreaServiceLocator()).getArea();
      if (area != null) {
        if (_endpoint != null)
  ...
  public com.metacube.Area getArea() {
    if (area == null)
      _initAreaProxy();
    return area;
  }
