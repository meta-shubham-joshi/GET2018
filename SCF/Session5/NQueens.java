...
public class NQueens {
	...
	/*
	 * Checks whether we can place a particular chess queen on a position or
	 * not.
	 * 
	 ...
	 * 
	 * @return whether a particular index is suitable for entering the chess
	 * queen or not.
	 */
	...
	/*
	 * Checks whether we can place chess queen appropriately so that there will
	 * be no attack on each other.
	 * 
	 * @params board- Contains the position matrix.
	 * 
	 * @params col-column number.
