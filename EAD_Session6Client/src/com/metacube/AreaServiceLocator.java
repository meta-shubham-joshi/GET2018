...
public class AreaServiceLocator extends org.apache.axis.client.Service implements com.metacube.AreaService {
    ...
    private java.lang.String Area_address = "http://localhost:8080/EAD_Session6/services/Area";
    ...
    public com.metacube.Area getArea() throws javax.xml.rpc.ServiceException {
    ...
    public com.metacube.Area getArea(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.AreaSoapBindingStub _stub = new com.metacube.AreaSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.Area.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.AreaSoapBindingStub _stub = new com.metacube.AreaSoapBindingStub(new java.net.URL(Area_address), this);
                _stub.setPortName(getAreaWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://metacube.com", "AreaService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://metacube.com", "Area"));
        }
