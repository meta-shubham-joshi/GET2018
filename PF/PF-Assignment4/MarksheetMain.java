...
public class MarksheetMain {
	...
	for(int i=0;i<n;i++)
	{
		...
		{
			System.out.println("Marks of a student cannot be negative or anything else.Please Reenter!!..");
			i--;
		}
	}
	...
	switch(x)
	{
		case 1: avgmarks = ms.avgGrades(studentmarks,n);
				System.out.println("Average of all grades is:" + avgmarks);
				break;
			
		case 2: maxmarks = ms.maxGrade(studentmarks,n);
				System.out.println("Maximum of all grades is:" + maxmarks);
				break;
		
		case 3: minmarks = ms.minGrade(studentmarks,n);
				System.out.println("Minimum of all grades is:" + minmarks);
				break;
		
		case 4: percentpassed = ms.percentOfStudentPassed(studentmarks,n);
				System.out.println("Percentage of all students passed is:" + percentpassed);
				break;
	}
