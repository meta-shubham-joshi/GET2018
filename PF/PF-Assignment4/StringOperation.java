...
public class StringOperation {
	 ...
	 * @params str1-first string.
	 * @params str2-Second string.
	...
	public String changeCase(String str)
	{
		try{
			...
			for(int i=0;i<strnew.length;i++)
			{
				...
				{
					System.out.println("The given string contains letters other than alphabets so it cannot be converted to other case!..");
					return str;
				}
